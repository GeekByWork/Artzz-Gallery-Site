    ...
    <div class="navbar navbar-fixed-top" style="background-color: white;">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand hidden-xs hidden-sm" href="#home"><span class="icon icon-pencil" style="font-size:18px; color:#3498db;"></span></a>
            </div>
...
<div id="greywrap">
    <div class="row">
        <div class="col-lg-4 callout">
            ...
            <h2>Sketches</h2>
            <p>Pencil sketches, pen sketches, charcoal sketches, crayon sketches, pastel sketches, and many more. </p>
        </div>

        <div class="col-lg-4 callout">
            <span class="icon icon-eye"></span>
            <h2>Paintings</h2>
            <p>Canvas paintings, water paintings, oil paintings, 3D paintings, poster paintings and many more. </p>
        </div>

        <div class="col-lg-4 callout">
            <span class="icon icon-lamp"></span>
            <h2>Crafty Art</h2>
            <p>Creativity has no limits. This section enlightens this fact with amazing creativity and filling art in everyday life. </p>
        </div>
    </div>
</div>
...
<div class="container" id="about" name="about">
    <div class="row white">
        <br>
        <h1 class="centered">A LITTLE ABOUT OUR GALLERY</h1>
        <hr>
...
<div class="container" id="services" name="services">
    ...
    <div class="row">
        <div class="col-lg-12">
            <img class="img-responsive" src="assets/img/art3.jpg" alt="">
        </div>
    </div>
    <h2 class="centered">OUR PAINTINGS - AS REAL AS YOURSELF.</h2>
    <hr>
    <br>
    <div class="row">
        <div class="col-lg-6">
            <img style="width:550px; height:480px" src="assets/img/art4.jpg" alt="">
        </div>
        <div class="col-lg-6">
            <img style="width:550px; height:480px" src="assets/img/art5.jpg" alt="">
        </div>
    </div>
</div>
...
<section class="section-divider textdivider divider4">
    <div class="container">
        <h1>ART CREATES EMOTIONAL CONNECTION</h1>
        <hr>
        <p>There’s more to art than meets the eye. It’s when it meets the heart that art creates a meaningful, lasting connection with the audience.</p>
    </div>
</section>
...
<div class="container" id="blog" name="blog">
    ...
    <div class="row">
        <div class="col-lg-6 blog-bg">
            ...
            <div class="col-lg-8 blog-co$idntent">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <!--
                ...
                <span class="icon icon-envelop"></span> <a href="#"> umang.saxena@sjsu.comu</a> <br/>
                <span class="icon icon-twitter"></span> <a href="#"> @artzz_co </a> <br/>
                <span class="icon icon-facebook"></span> <a href="#">Artzz Company</a> <br/>
            </p>
            -->
        </div>
        ...
        <div class="col-lg-4">
            <h3>Support Us</h3>
            <p>Please provide us with your valuable feedbacks and suggestions.</p>
        </div>
...
<div id="footerwrap">
    <div class="container">
        <h4>Created by - <a href="">Umang Saxena</a></h4>
    </div>
</div>
